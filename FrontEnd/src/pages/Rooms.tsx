...
export default function Rooms() {
  ...
  const handleConfirmPayment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`✅ Pembayaran sewa ${payMonths} bulan berhasil dicatat! Jatuh tempo baru: ${newDueDateObj.toLocaleDateString('id-ID', { day: '2-digit', month: 'long', year: 'numeric' })}`)
    } catch (error: any) {
                        ...
                        <div>
                          {dueStatus.isDue ? (
                            <div className="flex items-center p-2.5 bg-red-100 border border-red-200 rounded-lg text-red-800 text-xs font-bold animate-pulse shadow-xs">
                              ...
                              <span className="tracking-wide uppercase">⚠️ {dueStatus.message}</span>
                            </div>
                          ) : (
              ...
              <div className="bg-white px-6 pt-5 pb-4">
                ...
                <form onSubmit={handleConfirmPayment} className="space-y-3.5">
                  ...
                  <div className="p-2.5 bg-blue-50 rounded-lg border border-blue-200 text-[11px] text-blue-800 space-y-0.5">
                    <p className="font-semibold">💡 Info Perhitungan Jatuh Tempo:</p>
                    <p>
